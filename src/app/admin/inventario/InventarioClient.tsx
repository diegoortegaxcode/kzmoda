...
import {
  ...
  ArrowUpCircle, SlidersHorizontal, DollarSign, Boxes, FileDown, Loader2,
} from "lucide-react";
import {
  createProductAction, adjustStockAction,
  type ProductRow, type CategoryOption, type ActionResult,
} from "./actions";
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <textarea
                ...
                className="mt-1 w-full px-3 py-2 rounded-xl border border-slate-200 text-sm text-slate-900 placeholder-slate-300 focus:outline-none focus:border-[var(--brand-rose)] focus:ring-2 focus:ring-[var(--brand-rose)]/20 transition resize-none"
              />
            </div>
          </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-100">
                  {["Producto", "SKU", "Stock", "P. Costo", "P. Venta", "Margen", ""].map((h) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3.5">
                        <motion.button
                          ...
                          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold border border-slate-200 text-slate-600 hover:border-[var(--brand-rose)] hover:text-[var(--brand-rose)] hover:bg-[var(--brand-rose-light)] transition-all opacity-0 group-hover:opacity-100"
                        >
